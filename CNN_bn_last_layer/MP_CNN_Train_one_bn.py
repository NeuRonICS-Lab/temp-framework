...
if __name__ == '__main__':
    ...
    # initializing model
    #model.save_weights('Models/model_Batch32_Hid15_initalW_oneBN.hdf5')
    model.load_weights('Models/model_Batch32_Hid15_initalW_oneBN.hdf5') 
    ...
    # save model
    model.save_weights('Models/model_Batch32_Hid15_oldW_oneBN.hdf5')
